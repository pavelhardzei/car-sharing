...
class UsersManagersTests(TestCase):
    ...
    def test_create_car(self):
        ...
        car1 = Car.objects.create(brand='Mercedes', register_number='1111KK-1', color=Car.Color.blue, year=2020,
                                  weight=600, mileage=1000, category=category1)
        car2 = Car.objects.create(brand='BMW', register_number='2222KK-2', color=Car.Color.black, year=2021, weight=700,
        ...
        car_info1 = CarInfo.objects.create(car=car1, longitude='33.345612', latitude='34.124533', petrol_level=90,
                                           status=CarInfo.Status.available)
    ...
    def test_permissions(self):
        ...
        response = client.post(reverse('car-list'),
                               {'brand': 'Mercedes', 'register_number': '7777KC-7', 'color': Car.Color.brawn, 'year': 2020,
